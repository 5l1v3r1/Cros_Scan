...
def connect(host):
	CORS = commands.getoutput("curl -v -X GET "+str(host)+" -H 'Origen: http://evilwebsite.com'")

	if CORS.find("Access-Control-Allow-Origin: "+str(host)) != -1 or CORS.find("Access-Control-Allow-Credentials: true") != -1:
